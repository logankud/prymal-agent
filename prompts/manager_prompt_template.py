...
{{final_answer}}"""
    ...
    final_answer=FinalAnswerPromptTemplate(
        ...
        post_messages="""Based on the above, please summarize provide an answer to the user task.  Please answer as concisely as possible - if the user task can be answered with a single word or single number, do so.  The user will ask for more information if needed.  Here is the user following user task:
{{task}}"""
    )
)
